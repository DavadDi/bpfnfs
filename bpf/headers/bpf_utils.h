...
#define BPF_PERF_EVENT_ARRAY(name)                                                                                \
    ...
    static_always_inline __attribute__((unused)) int name##__perf_event_output(void *ctx, u64 *data, size_t size) \
    {                                                                                                             \
        return bpf_perf_event_output(ctx, &__##name, BPF_F_CURRENT_CPU, data, size);                              \
    }
